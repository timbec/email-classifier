This is a basic email classifier. It will use a pretrained model from HuggingFace to classify emails. It is built using FastAPI, my first time using the framework. 
